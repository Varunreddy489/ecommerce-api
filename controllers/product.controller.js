...
export const getFeaturedProducts = async (req, res) => {
  try {
    ...
    res.status(500).json({
      error: `error in getFeaturedProducts: ${error.message}`,
    });
  }
};
...
export const getProductsByCategory = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({
      error: `error in getProductsByCategory: ${error.message}`,
    });
  }
};
export const getRecommendedProducts = async (req, res) => {
  try {
    ...
    res.status(500).json({
      error: `error in getRecommendedProducts: ${error.message}`,
    });
  }
};
...
export const toggleFeaturedProduct = async (req, res) => {
  try {
    ...
    res.status(500).json({
      error: `error in toggleFeaturedProduct: ${error.message}`,
    });
  }
};
...
export const getAllProducts = async (req, res) => {
  try {
    ...
    res.status(500).json({
      error: `error in getAllProducts: ${error.message}`,
    });
  }
};
